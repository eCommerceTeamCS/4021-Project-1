...
```
This shows a violation of assumptions because there are multiple incidents which have very large Cook's distances.
...
```{r}
plot(casnd.lm1,which=6) #Cook's dist vs. Leverage
```
